...
public class BMResults implements Serializable {
    ...
    public BMResults(String bname, char CLASS, int bn1, int bn2, int bn3, int bniter, double btime, double bmops,
            String boptype, int passed_verification, int bid) {
        pid = bid;
        name = bname;
        clss = CLASS;
        n1 = bn1;
    ...
    public void print() {
        ...
        String outline = new String("***** NAS Parallel Benchmarks" + " Java version (NPB3_0_JAV) " + name + " ****");
        ...
        if (verified == 1)
            ...
            outline = new String("* Verification      = Not Performed");
        outbuf.insert(0, outline);
        outbuf.setLength(len);
        outbuf.insert(len - 1, "*");
        System.out.println(outbuf.toString());
        ...
        if (out != null) {
            try {
                outline = "***** NAS Parallel Benchmarks Java version (NPB3_0_JAV) " + name + " Report *****";
                ...
                if (n2 == 0 && n3 == 0) {
                    ...
                    outline = "Size            = " + String.valueOf(n1) + " X " + String.valueOf(n2) + " X "
                            + String.valueOf(n3);
                }
                out.write(outline, 0, outline.length());
                out.newLine();
    ...
    public static int printComparisonStatus(char clss, int verified, double epsilon, double xcr[], double xcrref[],
            double xcrdif[]) {
